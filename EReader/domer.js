                    ...
                    if (
                        ...
                        (He =
                            "FORBID_CONTENTS" in e
                                ? b({}, e.FORBID_CONTENTS, tt)
                                : ze),
                        (Ae =
                            "FORBID_TAGS" in e ? b({}, e.FORBID_TAGS, tt) : {}),
                        (_e =
                            "FORBID_ATTR" in e ? b({}, e.FORBID_ATTR, tt) : {}),
                        ...
                        Fe &&
                            ...
                            !0 === Fe.svgFilters &&
                                (b(he, L), b(Te, I), b(Te, U)),
                            !0 === Fe.mathMl && (b(he, x), b(Te, M), b(Te, U))),
                        e.ADD_TAGS &&
                            (he === ge && (he = S(he)), b(he, e.ADD_TAGS, tt)),
                        e.ADD_ATTR &&
                            (Te === ye && (Te = S(Te)), b(Te, e.ADD_ATTR, tt)),
                        e.ADD_URI_SAFE_ATTR && b(Ge, e.ADD_URI_SAFE_ATTR, tt),
                        e.FORBID_CONTENTS &&
                            (He === ze && (He = S(He)),
                            b(He, e.FORBID_CONTENTS, tt)),
                        Ue && (he["#text"] = !0),
            ...
            bt = function e(t) {
                ...
                for (
                    ...
                    (yt("uponSanitizeShadowNode", n, null),
                        Et(n) ||
                            (n.content instanceof s && e(n.content), Nt(n)));
        ...
        return (
            (o.sanitize = function (e) {
                ...
                if (xe) {
                    ...
                    return (
                        (Te.shadowroot || Te.shadowrootmode) &&
                            (l = ie.call(a, l, !0)),
                        l
                    );
                }
