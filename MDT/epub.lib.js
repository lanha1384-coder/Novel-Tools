    ...
    return (function (t) {
        ...
        function (t, e, i) {
            ...
            function u(t) {
                ...
                if (
                    ...
                    void 0 !== document.body.style[i]
                )
                    return t;
                for (var s = 0; s < n; s++)
                    if (void 0 !== document.body.style[e[s] + i])
                        return e[s] + i;
                return t;
            }
            function d(t) {
            ...
            function L(t, e, i) {
                ...
                if (
                    ...
                    (s = Array.prototype.slice.call(n, 0).filter(function (t) {
                        for (var e in i)
                            if (t.getAttribute(e) === i[e]) return !0;
                        return !1;
                    })))
                )
                    return s[0];
            ...
            class s {
                constructor(t, e, i) {
                    ...
                    if (
                        ...
                        return (
                            (this.str = t),
                            Object(n.extend)(this, this.parse(t))
                        );
                    if ("range" === r)
                        return Object(n.extend)(
                            this,
                            this.fromRange(t, this.base, i),
                        );
                    if ("node" === r)
                        return Object(n.extend)(
                            this,
                            this.fromNode(t, this.base, i),
                        );
                ...
                checkType(t) {
                    return this.isCfiString(t)
                        ...
                        : !t ||
                            "object" != typeof t ||
                            ("Range" !== Object(n.type)(t) &&
                                void 0 === t.startContainer)
                ...
                parseComponent(t) {
                    ...
                    return (
                        n.length > 1 &&
                            ((e = n[1]), (i.terminal = this.parseTerminal(e))),
                        "" === s[0] && s.shift(),
                        (i.steps = s.map(
                            function (t) {
                ...
                compare(t, e) {
                    ...
                    (t.range
                        ? ((i = t.path.steps.concat(t.start.steps)),
                          (r = t.start.terminal))
                ...
                fromRange(t, e, i) {
                    ...
                    if (
                        (i &&
                            (h =
                                null != s.ownerDocument.querySelector("." + i)),
                        "string" == typeof e
                        ...
                        for (
                            l = 0;
                            l < c &&
                            this.equalStep(n.start.steps[l], n.end.steps[l]);
                            l++
                        )
                            l === c - 1
                                ? n.start.terminal === n.end.terminal &&
                                  ...
                                  (n.range = !1))
                                : n.path.steps.push(n.start.steps[l]);
                        ((n.start.steps = n.start.steps.slice(
                            n.path.steps.length,
                        )),
                            (n.end.steps = n.end.steps.slice(
                                n.path.steps.length,
                            )));
                    }
                    return n;
                ...
                patchOffset(t, e, i) {
                    ...
                    var n = t,
                        s = e;
                    for (
                        t.parentNode.classList.contains(i) &&
                        (n = t.parentNode);
                        n.previousSibling;
                    ) {
                ...
                position(t) {
                    ...
                    return (
                        1 === t.nodeType
                            ...
                            : (i = (e = this.textNodes(t.parentNode)).indexOf(
                                  t,
                              )),
                        i
                    );
                    ...
                    for (
                        ...
                        ("element" === (s = t[r]).type
                            ? (a = s.id
                                  ...
                                  : (a.children || Object(n.findChildren)(a))[
                                        s.index
                                    ])
                            : "text" === s.type &&
                              (a = this.textNodes(a, i)[s.index]),
                        a);
                        r++
                    );
                    return a;
                ...
                collapse(t) {
                    this.range &&
                        ((this.range = !1),
                        t
                            ? ((this.path.steps = this.path.steps.concat(
                                  this.start.steps,
                              )),
        ...
        function (t, e, i) {
            ...
            e.a = class {
                ...
                resolve(t) {
                    ...
                    return t.indexOf("://") > -1
                        ? t
                        : ((e = r.a.resolve(this.directory, t)),
                          this.origin + e);
                }
                relative(t) {
            ...
            var o = {
                ...
                relative: function (t, e) {
                    ...
                    for (
                        ...
                        if (u === l) {
                            if (h > l) {
                                if (47 === e.charCodeAt(a + u))
                                    return e.slice(a + u + 1);
            ...
            function o(t, e) {
                ...
                t &&
                    ...
                    (s = Object(n.qs)(i, "link[rel='canonical']"))
                        ...
                        : ((s = t.createElement("link")).setAttribute(
                              "rel",
                              "canonical",
                          ),
                          s.setAttribute("href", r),
                        ...
                        : (e = (t = this._q.shift()).task)
                          ? (i = e.apply(this.context, t.args)) &&
                            "function" == typeof i.then
                              ? i.then(
                                    function () {
                                        t.deferred.resolve.apply(
                                            this.context,
                                            arguments,
                                        );
                                    }.bind(this),
                                    function () {
                                        t.deferred.reject.apply(
                                            this.context,
                                            arguments,
                                        );
                                    }.bind(this),
                                )
                              : (t.deferred.resolve.apply(this.context, i),
                                t.promise)
                          : t.promise
                            ? t.promise
                            : void 0;
        ...
        function (t, e, i) {
            ...
            var u = class {
                ...
                create(t) {
                    ...
                    (Object(r.extend)(this.settings, t),
                        t.height &&
                            Object(r.isNumber)(t.height) &&
                            (e = t.height + "px"),
                        t.width &&
                            Object(r.isNumber)(t.width) &&
                            (i = t.width + "px"));
                    ...
                    return (
                        ...
                        o &&
                            ...
                            (document.body.style.direction = o),
                        a
                    );
                }
                wrap(t) {
                ...
                size(t, e) {
                    ...
                    (null === t
                        ...
                        null === e
                            ? (i = i || this.element.getBoundingClientRect())
                                  .height &&
                              ((e = i.height),
                        ...
                        (this.containerPadding = {
                            left:
                                parseFloat(
                                    this.containerStyles["padding-left"],
                                ) || 0,
                            right:
                                parseFloat(
                                    this.containerStyles["padding-right"],
                                ) || 0,
                            top:
                                parseFloat(
                                    this.containerStyles["padding-top"],
                                ) || 0,
                            bottom:
                                parseFloat(
                                    this.containerStyles["padding-bottom"],
                                ) || 0,
                        }));
                ...
                direction(t) {
                    (this.container &&
                        ((this.container.dir = t),
                        (this.container.style.direction = t)),
                        this.settings.fullsize &&
                            (document.body.style.direction = t),
                        (this.settings.dir = t));
                }
                overflow(t) {
                    (this.container &&
            ...
            var d = class {
                    ...
                    find(t) {
                        for (var e, i = this.length, n = 0; n < i; n++)
                            if (
                                (e = this._views[n]).displayed &&
                                e.section.index == t.index
                            )
                                return e;
                    }
                    displayed() {
            ...
            class p {
                ...
                onOrientationChange(t) {
                    ...
                    (this.optsSettings.resizeOnOrientationChange &&
                        this.resize(),
                        clearTimeout(this.orientationTimeout),
                            ...
                            function () {
                                ((this.orientationTimeout = void 0),
                                    this.optsSettings
                                        ...
                                        this.resize(),
                                    this.emit(
                                        f.c.MANAGERS.ORIENTATION_CHANGE,
                                        e,
                                    ));
                            }.bind(this),
                            500,
                ...
                moveTo(t, e) {
                    ...
                    (this.isPaginated
                        ? ((i =
                              Math.floor(t.left / this.layout.delta) *
                              this.layout.delta) +
                              this.layout.delta >
                              ...
                              (i =
                                  ...
                                  this.layout.delta),
                          (n =
                              Math.floor(t.top / this.layout.delta) *
                              this.layout.delta) +
                              this.layout.delta >
                ...
                scrolledLocation() {
                    ...
                    return (
                        this.settings.fullsize &&
                            (r = s ? window.scrollY : window.scrollX),
                        t.map((t) => {
                            let o,
                                a,
                                h,
                    ...
                    return (
                        ...
                        t.map((t) => {
                            ...
                            ("rtl" === this.settings.direction
                                ...
                                : ((s = e.left + i),
                                  (a =
                                      Math.min(c.right - s, this.layout.width) -
                                      n),
                                  (r = s - c.left + n),
                                  (o = r + a)),
                                (n += a));
                            let d = this.mapping.page(
                                    t.contents,
                                    t.section.cfiBase,
                                    r,
                                    o,
                ...
                visible() {
                    for (
                        ...
                        ((t = i[r]),
                            !0 === this.isVisible(t, 0, 0, e) && s.push(t));
                    return s;
                }
                scrollBy(t, e, i) {
            ...
            e.a = class {
                ...
                findRanges(t) {
                    for (
                        var e,
                            ...
                            r =
                                Math.ceil(s / this.layout.spreadWidth) *
                                this.layout.divisor,
                ...
                findTextEndRange(t, e, i) {
                    for (
                        var n,
                            ...
                            h,
                            l,
                            c = this.splitTextNodeIntoRanges(t),
                            u = 0;
                        u < c.length;
                        u++
                    ) {
                        if (
                            ...
                            if (((o = r.left), (a = r.right) < e && n))
                                return n;
                            if (o < e) return s;
                        } else {
                            if (((h = r.top), (l = r.bottom), h > i && n))
                                return n;
                            if (l > i) return s;
                        }
                        n = s;
                ...
                splitTextNodeIntoRanges(t, e) {
                    ...
                    if (-1 === a || t.nodeType != Node.TEXT_NODE)
                        return (
                            (i = r.createRange()).selectNodeContents(t),
                            [i]
                        );
                    for (
                ...
                rangePairToCfiPair(t, e) {
                    ...
                    return (
                        ...
                        s.collapse(!1),
                        {
                            start: new n.a(i, t).toString(),
                            end: new n.a(s, t).toString(),
                        }
                    );
                }
                ...
                axis(t) {
                    return (
                        t && (this.horizontal = "horizontal" === t),
                        this.horizontal
                    );
                }
            };
            ...
            class f {
                        ...
                        t &&
                            ...
                            "no" === e.scalable
                                ...
                                : (e.scalable &&
                                      s.push("user-scalable=" + e.scalable),
                                  e.minimum &&
                                      s.push("minimum-scale=" + e.minimum),
                                  e.maximum &&
                                      s.push("minimum-scale=" + e.maximum)),
                            i ||
                                ((i =
                ...
                mediaQueryListeners() {
                    for (
                        ...
                        for (var s = 0; s < n.length; s += 1) {
                            if (n[s].media)
                                this.window
                                    .matchMedia(n[s].media.mediaText)
                                    .addListener(e);
                        }
                    }
                }
                        ...
                        if (s) {
                            try {
                                if (
                                    ...
                                    let t =
                                        s.startContainer.textContent.indexOf(
                                            " ",
                                            s.startOffset,
                                        );
                                    (-1 == t &&
                        ...
                        if (
                            ...
                            for (var n = 0, s = t.length; n < s; n++) {
                                var r = 1,
                                    ...
                                    h = "";
                                "[object Array]" ===
                                    Object.prototype.toString.call(o[1][0]) &&
                                    ((o = o[1]), (r = 0));
                ...
                direction(t) {
                    this.documentElement &&
                        (this.documentElement.style.direction = t);
                }
                mapPage(t, e, i, n, s) {
                ...
                writingMode(t) {
                    ...
                    return (
                        t &&
                            this.documentElement &&
                            (this.documentElement.style[e] = t),
                    ...
                    return (
                        n(t, [
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    for (
                                        var t = [], e = this.element.firstChild;
                                        e;
                                    )
        ...
        function (t, e, i) {
            ...
            var f = class {
                ...
                add(t, e) {
                    ...
                    i &&
                        ...
                        (i.url
                            ...
                            : i.serialized
                              ? (e.addStylesheetCss(i.serialized, t),
                                (i.injected = !0))
                              : i.rules &&
                                (e.addStylesheetRules(i.rules, t),
                                (i.injected = !0)));
                }
                override(t, e, i) {
                    ...
                    ((this._overrides[t] = { value: e, priority: !0 === i }),
                        n.forEach((e) => {
                            e.css(
                                t,
                                this._overrides[t].value,
                                this._overrides[t].priority,
                            );
                        }));
                }
                removeOverride(t) {
                ...
                overrides(t) {
                    ...
                    for (var i in e)
                        e.hasOwnProperty(i) &&
                            t.css(i, e[i].value, e[i].priority);
                }
                fontSize(t) {
            ...
            var g = class {
                    constructor(t) {
                        ((this.rendition = t),
                            ...
                            this.rendition.hooks.unloaded.register(
                    ...
                    _removeFromAnnotationBySectionIndex(t, e) {
                        this._annotationsBySectionIndex[t] =
                            this._annotationsAt(t).filter((t) => t !== e);
                    }
                    _annotationsAt(t) {
            ...
            class b {
                ...
                start() {
                    switch (
                        (this.settings.layout ||
                            ("pre-paginated" !==
                                this.book.package.metadata.layout &&
                                "true" !==
                                    this.book.displayOptions.fixedLayout) ||
                    ...
                    (this.manager ||
                        ...
                        (this.settings.globalLayoutProperties =
                            this.determineLayoutProperties(
                        ...
                        this.manager.on(
                            l.c.MANAGERS.REMOVED,
                            this.afterRemoved.bind(this),
                        ),
                        this.manager.on(
                            l.c.MANAGERS.RESIZED,
                    ...
                    if (this.book) {
                        ...
                        return (
                            ...
                            this.book.locations.length() &&
                                Object(r.isFloat)(t) &&
                                (t = this.book.locations.cfiFromPercentage(
                                    parseFloat(t),
                                )),
                ...
                afterDisplayed(t) {
                    (t.on(l.c.VIEWS.MARK_CLICKED, (e, i) =>
                        ...
                        this.hooks.render.trigger(t, this).then(() => {
                            t.contents
                                ? this.hooks.content
                                      .trigger(t.contents, this)
                                      .then(() => {
                                          this.emit(
                                              l.c.RENDITION.RENDERED,
                                              t.section,
                                              t,
                                          );
                                      })
                            ...
                            requestAnimationFrame(
                                function () {
                                    ...
                                    if (
                                        ...
                                        ((this.location = e),
                                            this.emit(
                                                l.c.RENDITION.LOCATION_CHANGED,
                                                {
                                                    index: this.location.start
                                                        .index,
                                                    href: this.location.start
                                                        .href,
                ...
                located(t) {
                    ...
                    let e = t[0],
                        ...
                        s = this.book.locations.locationFromCfi(
                            e.mapping.start,
                        ),
                    ...
                    (null != s &&
                        ...
                        null != r &&
                            ((n.end.location = r),
                            (n.end.percentage =
                                this.book.locations.percentageFromLocation(
                                    r,
                                ))));
                ...
                passEvents(t) {
                    (l.a.forEach((e) => {
                        ...
                        t.on(l.c.CONTENTS.SELECTED, (e) =>
                            this.triggerSelectedEvent(e, t),
                        ));
                }
            ...
            class c {
                ...
                create() {
                    return (
                        this.iframe ||
                            ...
                            (this.added = !0),
                            (this.elementBounds = Object(r.bounds)(
                                this.element,
                            )),
                ...
                render(t, e) {
                    return (
                        ...
                        this.size(),
                        this.sectionRender ||
                            (this.sectionRender = this.section.render(t)),
                        this.sectionRender
                            .then(
                                function (t) {
                                    return this.load(t);
                ...
                expand(t) {
                    ...
                    this.iframe &&
                        ...
                        ((this._expanding = !0),
                        "pre-paginated" === this.layout.name
                            ? ((i = this.layout.columnWidth),
                              (n = this.layout.height))
                            : "horizontal" === this.settings.axis
                              ? ((i = this.contents.textWidth()) %
                              ...
                              : "vertical" === this.settings.axis &&
                                ...
                                "paginated" === this.settings.flow &&
                                    ...
                                    (n =
                                        Math.ceil(n / this.layout.height) *
                                        this.layout.height)),
                        (this._needsReframe ||
                            i != this._width ||
                            n != this._height) &&
                ...
                reframe(t, e) {
                    ...
                    (Object(r.isNumber)(t) &&
                        ...
                        (i = {
                            width: t,
                            height: e,
                            widthDelta: this.prevBounds
                                ? t - this.prevBounds.width
                                : t,
                            heightDelta: this.prevBounds
                                ? e - this.prevBounds.height
                                : e,
                        }),
                        ...
                        requestAnimationFrame(() => {
                            ...
                            for (let e in this.marks)
                                this.marks.hasOwnProperty(e) &&
                                    ((t = this.marks[e]),
                                    this.placeMark(t.element, t.range));
                        }),
                ...
                load(t) {
                    ...
                    if (
                        ...
                        if (
                            ...
                            return (
                                e.reject(new Error("No Document Available")),
                                i
                            );
                        if (
                ...
                onLoad(t, e) {
                    ((this.window = this.iframe.contentWindow),
                        ...
                        (this.rendering = !1));
                    var i = this.document.querySelector(
                        "link[rel='canonical']",
                    );
                    (i
                        ? i.setAttribute("href", this.section.canonical)
                        : ((i =
                              this.document.createElement("link")).setAttribute(
                              "rel",
                              "canonical",
                          ),
                          i.setAttribute("href", this.section.canonical),
                ...
                setLayout(t) {
                    ((this.layout = t),
                        this.contents &&
                            (this.layout.format(this.contents), this.expand()));
                }
                setAxis(t) {
                    ((this.settings.axis = t),
                        (this.element.style.flex =
                            "horizontal" == t ? "none" : "initial"),
                        this.size());
                }
                setWritingMode(t) {
                    this.writingMode = t;
                ...
                locationOf(t) {
                    ...
                    var e = this.contents.locationOf(
                        t,
                ...
                mark(t, e = {}, i) {
                    ...
                    n.collapsed && 1 === s.nodeType
                        ...
                        : n.collapsed &&
                          ((n = new Range()), n.selectNodeContents(r));
        ...
        function (t, e, i) {
            ...
            class c {
                    ...
                    ((this.manager = t),
                        ...
                        this.fullsize
                            ...
                            : ((this.element = this.manager.stage.container),
                              ...
                              (this.element.style.WebkitOverflowScrolling =
                                  "touch")),
                        (this.manager.settings.offset = this.layout.width),
                        (this.manager.settings.afterScrolledTimeout =
                            2 * this.settings.duration),
                        (this.isVertical =
                            "vertical" === this.manager.settings.axis),
                ...
                onTouchEnd(t) {
                    (this.fullsize && this.disableScroll(),
                        (this.touchCanceler = !1));
                ...
                needsSnap() {
                    return (
                        this.scrollLeft %
                            (this.layout.pageWidth * this.layout.divisor) !=
                        0
                    );
                }
                snap(t = 0) {
                ...
                smoothScrollTo(t) {
                    ...
                    return (
                        ...
                        function n() {
                            ...
                            if (
                                (o(h),
                                this.touchCanceler || this.resizeCanceler)
                            )
                                return (
                                    (this.resizeCanceler = !1),
                                    (this.snapping = !1),
                            ...
                            function (t, e, i) {
                                ...
                                ((e.exports = l),
                                    ...
                                    (r.resolve = function (t, e) {
                                        var i = p(d, e);
                                        if ("error" === i.status)
                                            return r.reject(t, i.value);
                                        var n = i.value;
                                        if (n) f(t, n);
                                        else {
                                            ((t.state = a), (t.outcome = e));
                                            for (
                                                var s = -1, o = t.queue.length;
                                                ++s < o;
                                            )
                            ...
                            function (t, e, i) {
                                ...
                                var tt = new ((function () {
                                    ...
                                    return (
                                        ...
                                        (t.prototype.getDriver = function (
                                            t,
                                            e,
                                            i,
                                        ) {
                                        ...
                                        (t.prototype.setDriver = function (
                                            t,
                                            e,
                                            i,
                                        ) {
                                        ...
                                        (t.prototype._wrapLibraryMethodsWithReady =
                                            function () {
                                                for (
                                                    var t = 0, e = K.length;
                                                    t < e;
        ...
        function (t, e, i) {
            ...
            var f = class {
                ...
                render(t) {
                    ...
                    return (
                        ...
                        this.load(t)
                            .then(
                                function (t) {
                                    var e =
                                        ...
                                        i = new (
                                            "undefined" ==
                                                typeof XMLSerializer || e
                                                ? d.DOMParser
                                                : XMLSerializer
                                        )();
                                    return (
                                        (this.output = i.serializeToString(t)),
                                        this.output
                                    );
                                }.bind(this),
                            )
                            .then(
                                function () {
                                    return this.hooks.serialize.trigger(
                                        this.output,
                                        this,
                                    );
                                }.bind(this),
                ...
                search(t, e = 5) {
                    if (void 0 === document.createTreeWalker)
                        return this.find(t);
                    let i = [];
                    const n = this,
                        s = t.toLowerCase(),
                            ...
                            if (-1 != e) {
                                ...
                                if (e < t[r].length) {
                                    ...
                                    let d = t
                                        .slice(0, a)
                                        .reduce(
                                            (t, e) => t + e.textContent.length,
                                            0,
                                        );
                                    (u.setEnd(c, d > o ? o : o - d),
                                        (s = n.cfiFromRange(u)));
                                    let f = t
                                        .slice(0, a + 1)
                                        .reduce(
                    ...
                    unpack(t, e, i) {
                        ((this.items = t.spine),
                            ...
                            this.items.forEach((t, n) => {
                                ...
                                ((t.index = n),
                                    (t.cfiBase =
                                        this.epubcfi.generateChapterComponent(
                                            this.spineNodeIndex,
                                            t.index,
                                            t.id,
                                        )),
            ...
            class v {
                ...
                generate(t) {
                    return (
                        ...
                        this.spine.each(
                            function (t) {
                                t.linear &&
                                    this.q.enqueue(this.process.bind(this), t);
                            }.bind(this),
                        ),
                        this.q.run().then(
                            function () {
                        ...
                        (Object(r.sprint)(
                            ...
                            function (t) {
                                var i,
                                    r = t.length,
                                    a = 0;
                                if (0 === t.textContent.trim().length)
                                    return !1;
                                for (
                                    0 == c &&
                                        (((n =
                                            this.createRange()).startContainer =
                                            t),
                                        (n.startOffset = 0)),
                                        (i = u - c) > r && ((c += r), (a = r));
                                    a < r;
                ...
                parseWords(t, e, i, n) {
                    ...
                    n &&
                        ...
                        (s = n.findNode(
                            n.range
                                ? n.path.steps.concat(n.start.steps)
                                : n.path.steps,
                            t.ownerDocument,
                        ));
                    return (
                ...
                cfiFromPercentage(t) {
                    ...
                    return (
                        (e = Math.ceil(this.total * t)),
                        this.cfiFromLocation(e)
                    );
                }
                load(t) {
                    return (
            ...
            var E = class {
                ...
                parseMetadata(t) {
                    ...
                    return (
                        ...
                        (e.modified_date = this.getPropertyText(
                            t,
                            "dcterms:modified",
                        )),
                        (e.layout = this.getPropertyText(
                            t,
                            "rendition:layout",
                        )),
                        (e.orientation = this.getPropertyText(
                            t,
                            "rendition:orientation",
                        )),
                        (e.flow = this.getPropertyText(t, "rendition:flow")),
                        (e.viewport = this.getPropertyText(
                            t,
                            "rendition:viewport",
                        )),
                    ...
                    return (
                        ...
                        t.resources.forEach((t, e) => {
                            ((this.manifest[e] = t),
                                t.rel &&
                                    "cover" === t.rel[0] &&
                                    (this.coverPath = t.href));
                        }),
                        (this.spineNodeIndex = 0),
                        (this.toc = t.toc.map(
                            (t, e) => ((t.label = t.title), t),
                        )),
                        {
                            metadata: this.metadata,
                            spine: this.spine,
            ...
            var S = class {
                    ...
                    getByIndex(t, e, i) {
                        ...
                        if (!n || (t !== n.id && t !== n.href)) {
                            ...
                            for (
                                let s = 0;
                                s < i.length &&
                                ((n = this.getByIndex(t, e, i[s].subitems)),
                                !n);
                                ++s
                            );
                            return n;
                    ...
                    parseLandmarks(t) {
                        var e,
                            i,
                            n = Object(r.querySelectorByType)(
                                t,
                                "nav",
                                "landmarks",
                            ),
                    ...
                    load(t) {
                        return t.map(
                            (t) => (
                                (t.label = t.title),
                                (t.subitems = t.children
                                    ? this.load(t.children)
                                    : []),
                                t
                            ),
                        );
            ...
            var C = class {
                ...
                replacements() {
                    ...
                    var t = this.urls.map((t) => {
                        ...
                        return this.createUrl(e).catch(
                            (t) => (console.error(t), null),
                        );
                    });
                    return Promise.all(t).then(
                        (t) => (
                            (this.replacementUrls = t.filter(
                                (t) => "string" == typeof t,
                            )),
                            t
                        ),
            ...
            var O = class {
                    ...
                    ncxItem(t) {
                        ...
                        return {
                            href: Object(r.qs)(t, "content").getAttribute(
                                "src",
                            ),
                            page: parseInt(i, 10),
                        };
                    ...
                    process(t) {
                        (t.forEach(function (t) {
                            (this.pages.push(t.page),
                                t.cfi && this.locations.push(t.cfi));
                        }, this),
            ...
            var A = class {
                    ...
                    request(t, e) {
                        ...
                        return (
                            e || (e = s.extension),
                            (i =
                                "blob" == e ? this.getBlob(t) : this.getText(t))
                                ? i.then(
                                      function (t) {
            ...
            class D {
                ...
                retrieve(t, e) {
                    ...
                    return (
                        e || (e = i.extension),
                        ("blob" == e ? this.getBlob(t) : this.getText(t)).then(
                            (i) => {
                                var n,
                                    s = new r.defer();
                                return (
                                    i
                                        ? ((n = this.handleResponse(i, e)),
                                          s.resolve(n))
                                        : s.reject({
                                              message:
            ...
            class H {
                ...
                openEpub(t, e) {
                    return this.unarchive(t, e || this.settings.encoding)
                        .then(() =>
                            this.openContainer("META-INF/container.xml"),
                        )
                            ...
                            ? this.load(
                                  ...
                                  .then((t) => {
                                      ((this.displayOptions = new M(t)),
                                          this.loading.displayOptions.resolve(
                                              this.displayOptions,
                                          ));
                                  })
                                  .catch((t) => {
                    ...
                    return i
                        ? new Promise((e, n) => {
                              ((this.navigation = new S(i)),
                                  t.pageList &&
                                      (this.pageList = new O(t.pageList)),
                                  e(this.navigation));
                          })
                        : e
                ...
                store(t) {
                    ...
                    return (
                        ...
                        (this.request = this.storage.request.bind(
                            this.storage,
                        )),
                        this.opened.then(() => {
                            this.archived &&
                                (this.storage.requester =
                                    this.archive.request.bind(this.archive));
                            let t = (t, e) => {
                            ...
                            ((this.resources.settings.replacements =
                                ...
                                this.storage.on("online", () => {
                                    ((this.url = i),
                                        this.spine.hooks.serialize.deregister(
                                            t,
                                        ));
                                }));
                        }),
        ...
        function (t, e, i) {
            ...
            var l = {},
                ...
                N =
                    ...
                    (E.DOMSTRING_SIZE_ERR =
                        ((S[2] = "DOMString size error"), 2)),
                    (E.HIERARCHY_REQUEST_ERR =
                        ((S[3] = "Hierarchy request error"), 3))),
                _ =
                    ((E.WRONG_DOCUMENT_ERR = ((S[4] = "Wrong document"), 4)),
                    (E.INVALID_CHARACTER_ERR =
                        ((S[5] = "Invalid character"), 5)),
                        ...
                        if (
                            ...
                            if (x !== t.namespaceURI)
                                for (S = r.length - 1; S >= 0; S--) {
                                    var N;
                                    if (
                                        (N = r[S]).namespace === t.namespaceURI
                                    ) {
            ...
            ((C.prototype = Error.prototype),
                ...
                (B.prototype.getElementsByTagName =
                    H.prototype.getElementsByTagName),
        ...
        function (t, e, i) {
            ...
            function u(t, e, i) {
                ...
                var f;
                (f = s.indexOf(":")) > 0
                    ? ((c = t.prefix = s.slice(0, f)),
                      (u = t.localName = s.slice(f + 1)))
                    : ((c = null), (u = t.localName = s));
                var g = (t.uri = i[c || ""]);
                if ((e.startElement(g, u, s, t), !t.closed))
                    return ((t.currentNSMap = i), (t.localNSMap = r), !0);
                if ((e.endElement(g, u, s), r))
                    for (c in r) e.endPrefixMapping(c);
            }
        ...
        function (t, e, i) {
            ...
            function n(t, e) {
                function i(i) {
                    for (var n = e.length - 1; n >= 0; n--) {
                        ...
                        if (
                            (i.touches &&
                                i.touches.length &&
                                ((a = i.touches[0].clientX),
                                (h = i.touches[0].clientY)),
                            r(o, t, a, h))
                        ) {
                            o.dispatchEvent(s(i));
                            break;
                ...
                for (
                    var n = ["mouseup", "mousedown", "click", "touchstart"],
                        o = 0;
                    o < n.length;
                    o++
                ) {
            ...
            function r(t, e, i, n) {
                ...
                for (
                    var o = t.getClientRects(), a = 0, h = o.length;
                    a < h;
                    a++
                )
        ...
        function (t, e, i) {
            ...
            t.exports = function (t) {
                return (
                    "symbol" == typeof t || (s(t) && "[object Symbol]" == n(t))
                );
            };
        },
        function (t, e, i) {
